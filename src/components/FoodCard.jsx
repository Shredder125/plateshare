    ...
    <div className="group relative bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-3xl shadow-2xl overflow-hidden transform hover:scale-105 hover:shadow-orange-500/20 transition-all duration-500 flex flex-col border border-gray-800 hover:border-orange-500/50">
      <div className="h-48 sm:h-56 md:h-60 w-full overflow-hidden rounded-t-3xl relative">
        ...
        {isAvailable ? (
          ...
          <div className="absolute top-4 right-4 flex items-center gap-2 bg-gradient-to-r from-red-600 to-rose-600 px-3 py-1.5 rounded-full shadow-lg backdrop-blur-sm">
            <span className="text-white text-xs font-semibold">Donated</span>
          </div>
        )}
      ...
      <div className="p-5 flex flex-col justify-between flex-1 space-y-4">
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1">
            ...
            <p className="text-orange-400 font-semibold text-sm line-clamp-1"> 
        ...
        <div className="space-y-2">
          <div className="flex items-center gap-2 text-gray-300">
            ...
            <span className="text-sm">{food.foodQuantity} servings</span>
          </div>
          <div className="flex items-center gap-2 text-gray-300">
