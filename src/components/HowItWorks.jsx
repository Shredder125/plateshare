        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 relative">
            ...
            {steps.map((step, index) => (
              ...
              >
                <div
                  className={`absolute -inset-1 bg-gradient-to-r ${step.color} rounded-3xl blur-lg opacity-20 group-hover:opacity-40 transition duration-500`}
                ></div>
                ...
                <div className="relative flex flex-col items-center p-8 rounded-3xl bg-gradient-to-br from-gray-900 via-gray-800 to-black border border-gray-800 group-hover:border-orange-500/50 transition-all duration-500 shadow-2xl group-hover:shadow-orange-500/20 transform group-hover:scale-105">
                  <div className="absolute -top-6 left-1/2 -translate-x-1/2">
                    <div
                      className={`w-12 h-12 rounded-xl bg-gradient-to-br ${step.color} flex items-center justify-center shadow-lg border-4 border-gray-900 group-hover:rotate-12 transition-transform duration-500`}
                    >
                  ...
                  <div
                    className={`w-20 h-20 mb-6 mt-4 rounded-2xl bg-gradient-to-br ${step.color} flex items-center justify-center shadow-lg transform group-hover:scale-110 group-hover:rotate-6 transition-all duration-500`}
                  >
                  ...
                  <div
                    className={`absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r ${step.color} rounded-b-3xl transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500`}
                  ></div>
                </div>
                ...
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute top-1/2 -right-6 lg:-right-12 w-12 lg:w-24 h-0.5">
                    <div
                      className={`w-full h-full bg-gradient-to-r ${step.color} opacity-30`}
                    >
